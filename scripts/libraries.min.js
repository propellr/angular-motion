!function(a, b) {
    ...
    angular.module("mgcrea.ngStrap.affix", [ "mgcrea.ngStrap.helpers.dimensions" ]).provider("$affix", function() {
        ...
        this.$get = [ "$window", "dimensions", function(b, c) {
            function d(d, g) {
                ...
                var r = 0;
                j.offsetTop && ("auto" === j.offsetTop && (j.offsetTop = "+0"), j.offsetTop.match(/^[-+]\d+$/) ? (l -= 1 * j.offsetTop, 
                r = j.offsetParent ? c.offset(p[0]).top + 1 * j.offsetTop : c.offset(d[0]).top - c.css(d[0], "marginTop", !0) + 1 * j.offsetTop) : r = 1 * j.offsetTop);
                var s = 0;
                return j.offsetBottom && (s = j.offsetParent && j.offsetBottom.match(/^[-+]\d+$/) ? b.document.body.scrollHeight - (c.offset(p[0]).top + c.height(p[0])) + 1 * j.offsetBottom + 1 : 1 * j.offsetBottom), 
                i.init = function() {
                    m = c.offset(d[0]).top + l, e.on("scroll", this.checkPosition), e.on("click", this.checkPositionWithEventLoop), 
                    ...
                    n !== i && (n = i, d.removeClass(k).addClass("affix" + ("middle" !== i ? "-" + i : "")), 
                    "top" === i ? (o = null, d.css("position", j.offsetParent ? "" : "relative"), d.css("top", "")) : "bottom" === i ? (o = j.offsetUnpin ? -(1 * j.offsetUnpin) : e.top - a, 
                    d.css("position", j.offsetParent ? "" : "relative"), d.css("top", j.offsetParent ? "" : f[0].offsetHeight - s - g - m + "px")) : (o = null, 
                    d.css("position", "fixed"), d.css("top", l + "px")));
                }, i.init(), i;
            }
        ...
        this.$get = [ "$window", "$document", "$rootScope", "$sce", "$locale", "dateFilter", "datepickerViews", "$tooltip", function(b, c, d, e, f, g, h, i) {
            function j(b, c, d) {
                ...
                var g = i(b, angular.extend({}, a, d)), j = d.scope, m = g.$options, n = g.$scope, o = h(g);
                g.$views = o.views;
                var p = o.viewDate;
                n.$mode = m.startView;
                ...
                n.$select = function(a) {
                    ...
                    isNaN(a.getTime()) ? q.built || g.$build() : (g.$date = a, q.update.call(q, a));
                }, g.select = function(a, b) {
                    angular.isDate(a) || (a = new Date(a)), c.$dateValue.setFullYear(a.getFullYear(), a.getMonth(), a.getDate()), 
            ...
            var k = (angular.element(b.document.body), "createTouch" in b.document), l = /(iP(a|o)d|iPhone)/g.test(b.navigator.userAgent);
        ...
        {
            var h = /(iP(a|o)d|iPhone)/g.test(a.navigator.userAgent);
            a.requestAnimationFrame || a.setTimeout;
        }
        return {
            restrict: "EAC",
            ...
            link: function(a, b, c, d) {
                ...
                angular.forEach([ "placement", "container", "delay", "trigger", "keyboard", "html", "animation", "template", "autoclose", "dateType", "dateFormat", "useNative", "lang" ], function(a) {
                ...
                d.$parsers.unshift(function(a) {
                    ...
                    return d.$dateValue = b, "string" === i.dateType ? e(a, i.dateFormat) : "number" === i.dateType ? d.$dateValue.getTime() : "iso" === i.dateType ? d.$dateValue.toISOString() : d.$dateValue;
        ...
        this.$get = [ "$locale", "$sce", "dateFilter", function(b, c, d) {
            return function(e) {
                var f = e.$scope, g = e.$options, h = b.DATETIME_FORMATS.SHORTDAY, i = h.slice(g.weekStart).concat(h.slice(0, g.weekStart)), j = c.trustAsHtml('<th class="dow text-center">' + i.join('</th><th class="dow text-center">') + "</th>"), k = e.$date || new Date(), l = {
                    year: k.getFullYear(),
                    month: k.getMonth(),
                    date: k.getDate()
                    ...
                    build: function() {
                        for (var b, c = new Date(l.year, l.month, 1), h = new Date(+c - 864e5 * (c.getDay() - g.weekStart)), i = [], k = 0; 35 > k; k++) b = new Date(h.getFullYear(), h.getMonth(), h.getDate() + k), 
                        i.push({
                            date: b,
        ...
        this.$get = [ "$window", "$rootScope", "$compile", "$q", "$templateCache", "$http", "$animate", "$timeout", "dimensions", function(c, d, e, f, g, h, i) {
            function j(b) {
                ...
                }, q.contentTemplate && (j.$promise = j.$promise.then(function(a) {
                    angular.isObject(a) && (a = a.data);
                    var c = angular.element(a);
                    return f.when(g.get(q.contentTemplate) || h.get(q.contentTemplate)).then(function(a) {
                        angular.isObject(a) && (a = a.data);
                        var d = p('[ng-bind="content"]', c[0]).removeAttr("ng-bind").html(a);
                ...
                return j.$promise.then(function(a) {
                    angular.isObject(a) && (a = a.data), q.html && (a = a.replace(o, 'ng-bind-html="')), 
                    a = m.apply(a), s = e(a), j.init();
                }), j.init = function() {
                    ...
                    t = j.$element = s(r, function() {}), t.css({
                        display: "block"
                    }).addClass(q.placement), q.animation && (q.backdrop && u.addClass("animation-fade"), 
                    t.addClass(q.animation)), q.backdrop && i.enter(u, n, null, function() {}), i.enter(t, a, b, function() {}), 
                    r.$isShown = !0, r.$$phase || r.$digest(), j.focus(), n.addClass(q.prefixClass + "-open"), 
                    q.backdrop && (t.on("click", c), u.on("click", c)), q.keyboard && t.on("keyup", j.$onKeyUp);
                }, j.hide = function() {
                    i.leave(t, function() {
                        n.removeClass(q.prefixClass + "-open");
                    }), q.backdrop && i.leave(u, function() {}), r.$$phase || r.$digest(), r.$isShown = !1, 
                    q.backdrop && (t.off("click", c), u.off("click", c)), q.keyboard && t.off("keyup", j.$onKeyUp);
                }, j.toggle = function() {
        ...
        return {
            ...
            link: function(a, b, c, g) {
                ...
                var i = e(c.ngOptions), j = d(b, g, h), k = i.$match[7].replace(/\|.+/, "").trim();
                a.$watch(k, function() {
                    ...
                    }).filter(angular.isDefined).join(", ") : (d = j.$getIndex(g.$modelValue), a = angular.isDefined(d) ? j.$scope.$matches[d].label : !1), 
        ...
        this.$get = [ "$window", "$document", "$rootScope", "$sce", "$locale", "dateFilter", "$tooltip", function(b, c, d, e, f, g, h) {
            function i(b, c, d) {
                ...
                o.$select = function(a, b) {
                    ...
                    isNaN(a.getTime()) ? l.$isBuilt || l.$build() : (l.$date = a, angular.extend(r, {
                        hour: a.getHours(),
                        minute: a.getMinutes(),
                        second: a.getSeconds(),
                    ...
                    angular.isDate(a) || (a = new Date(a)), 0 === b ? c.$dateValue.setHours(a.getHours()) : 1 === b && c.$dateValue.setMinutes(a.getMinutes()), 
                ...
                var u = l.init;
                l.init = function() {
                    j && (b.prop("type", "text"), b.attr("readonly", "true"), b.on("click", i)), u();
                };
                var v = l.destroy;
                l.destroy = function() {
            ...
            var j = (angular.element(b.document.body), "createTouch" in b.document), k = /(iP(a|o)d|iPhone)/g.test(b.navigator.userAgent);
        ...
        return {
            ...
            link: function(a, b, c, d) {
                ...
                angular.forEach([ "minTime", "maxTime" ], function(a) {
                    angular.isDefined(c[a]) && c.$observe(a, function(b) {
                        i.$options[a] = "now" === b ? new Date().setFullYear(1970, 0, 1) : angular.isString(b) && b.match(/^".+"$/) ? +new Date(b.substr(1, b.length - 2)) : j.parse(b), 
                        !isNaN(i.$options[a]) && i.$build();
                    });
                }), a.$watch(c.ngModel, function() {
                    i.update(d.$dateValue);
                }, !0), d.$parsers.unshift(function(a) {
                    var b = j.parse(a, d.$dateValue);
                    if (!b || isNaN(b.getTime())) d.$setValidity("date", !1); else {
                        var c = b.getTime() >= h.minTime && b.getTime() <= h.maxTime;
                        d.$setValidity("date", c), c && (d.$dateValue = b);
                    }
                    return "string" === h.timeType ? e(a, h.timeFormat) : "number" === h.timeType ? d.$dateValue.getTime() : "iso" === h.timeType ? d.$dateValue.toISOString() : d.$dateValue;
                }), d.$formatters.push(function(a) {
                    var b = angular.isDate(a) ? a : new Date(a);
                    return isNaN(b.getTime()) && (b = new Date(new Date().setMinutes(0) + 36e5)), d.$dateValue = b, 
                    d.$dateValue;
                }), d.$render = function() {
        ...
        this.$get = [ "$window", "$rootScope", "$compile", "$q", "$templateCache", "$http", "$animate", "$timeout", "dimensions", function(c, d, e, f, g, h, i, j, k) {
            function l(b, c) {
                ...
                r.delay && angular.isString(r.delay) && (r.delay = parseFloat(r.delay)), r.title && (q.$scope.title = r.title), 
                s.$hide = function() {
                ...
                var t, u;
                r.contentTemplate && (q.$promise = q.$promise.then(function(a) {
                    angular.isObject(a) && (a = a.data);
                    var b = angular.element(a);
                    return f.when(g.get(r.contentTemplate) || h.get(r.contentTemplate, {
                        cache: g
                    })).then(function(a) {
                        return angular.isObject(a) && (a = a.data), p('[ng-bind="content"]', b[0]).removeAttr("ng-bind").html(a), 
                        b[0].outerHTML;
                    });
                }));
                var v, w, x;
                return q.$promise.then(function(a) {
                    angular.isObject(a) && (a = a.data), r.html && (a = a.replace(o, 'ng-bind-html="')), 
                    a = m.apply(a), x = a, v = e(a), q.init();
                }), q.init = function() {
                    r.delay && angular.isNumber(r.delay) && (r.delay = {
                        show: r.delay,
                        hide: r.delay
                    });
                    for (var a = r.trigger.split(" "), c = a.length; c--; ) {
                        var d = a[c];
                        "click" === d ? b.on("click", q.toggle) : "manual" !== d && (b.on("hover" === d ? "mouseenter" : "focus", q.enter), 
                        b.on("hover" === d ? "mouseleave" : "blur", q.leave));
                    }
                    ...
                    for (var a = r.trigger.split(" "), c = a.length; c--; ) {
                        var d = a[c];
                        "click" === d ? b.off("click", q.toggle) : "manual" !== d && (b.off("hover" === d ? "mouseenter" : "focus", q.enter), 
                        b.off("hover" === d ? "mouseleave" : "blur", q.leave));
                    }
                    ...
                    w = q.$element = v(s, function() {}), w.css({
                        top: "0px",
                        left: "0px",
                        display: "block"
                    }).addClass(r.placement), r.animation && w.addClass(r.animation), r.type && w.addClass(r.prefixClass + "-" + r.type), 
                    i.enter(w, a, c, function() {}), q.$isShown = !0, s.$$phase || s.$digest(), n(q.$applyPlacement), 
                    r.keyboard && ("focus" !== r.trigger ? (q.focus(), w.on("keyup", q.$onKeyUp)) : b.on("keyup", q.$onFocusKeyUp));
                }, q.leave = function() {
                    return q.$isShown ? (clearTimeout(t), u = "out", r.delay && r.delay.hide ? void (t = setTimeout(function() {
                        "out" === u && q.hide();
                    }, r.delay.hide)) : q.hide()) : void 0;
                }, q.hide = function(a) {
                    return i.leave(w, function() {}), s.$$phase || s.$digest(), q.$isShown = !1, r.keyboard && w.off("keyup", q.$onKeyUp), 
                    a && "focus" === r.trigger ? b[0].blur() : void 0;
                }, q.toggle = function() {
    ...
    angular.module("mgcrea.ngStrap.aside").run([ "$templateCache", function(a) {
        ...
        a.put("popover/popover.tpl.html", '<div class="popover" ng-show="content"><div class="arrow"></div><h3 class="popover-title" ng-bind="title" ng-show="title"></h3><div class="popover-content" ng-bind="content"></div></div>');
        ...
        a.put("tooltip/tooltip.tpl.html", '<div class="tooltip" ng-show="title"><div class="tooltip-arrow"></div><div class="tooltip-inner" ng-bind="title"></div></div>');
