!function(a, b) {
    ...
    angular.module("mgcrea.ngStrap.affix", [ "mgcrea.ngStrap.helpers.dimensions" ]).provider("$affix", function() {
        ...
        this.$get = [ "$window", "$document", "$rootScope", "$sce", "$locale", "dateFilter", "datepickerViews", "$tooltip", function(b, c, d, e, f, g, h, i) {
            function j(b, c, d) {
                ...
                l.$select = function(a) {
                    ...
                    angular.isDate(a) || (a = new Date(a)), !f.$mode || d ? (c.$setViewValue(a), c.$render(), 
                    j.autoclose && !d && ("focus" === j.trigger ? b[0].blur() : f.hide())) : (angular.extend(n, {
                        year: a.getUTCFullYear(),
                        month: a.getUTCMonth(),
                        date: a.getUTCDate()
                    }), f.setMode(f.$mode - 1), f.$build());
                ...
                return f.hide = function() {
                    f.$element.off(k ? "touchstart" : "mousedown", f.$onMouseDown), j.keyboard && b.off("keydown", f.$onKeyDown), 
                    r();
                }, f;
            }
        ...
        var b = Date.prototype, c = this.defaults = {
            format: "shortDate"
        };
        this.$get = [ "$locale", function(d) {
            ...
            var e = function(c) {
                ...
                var h, i, j = {
                    ...
                    ".": "[.]",
                    " ": "[\\s]",
                    EEEE: "((?:" + d.DATETIME_FORMATS.DAY.join("|") + "))",
                    EEE: "((?:" + d.DATETIME_FORMATS.SHORTDAY.join("|") + "))",
                    dd: "((?:(?:[0-2]?[0-9]{1})|(?:[3][01]{1})))",
                    d: "((?:(?:[0-2]?[0-9]{1})|(?:[3][01]{1})))",
                    MMMM: "((?:" + d.DATETIME_FORMATS.MONTH.join("|") + "))",
                    MMM: "((?:" + d.DATETIME_FORMATS.SHORTMONTH.join("|") + "))",
                    MM: "((?:[0]?[1-9]|[1][012]))",
                    M: "((?:[0]?[1-9]|[1][012]))",
        ...
        this.$get = [ "$locale", "$sce", "dateFilter", function(b, c, d) {
            return function(e) {
                var f = e.$scope, g = e.$options, h = b.DATETIME_FORMATS.SHORTDAY, i = h.slice(g.weekStart).concat(h.slice(0, g.weekStart)), j = c.trustAsHtml('<th class="dow text-center">' + i.join('</th><th class="dow text-center">') + "</th>"), k = e.$date || new Date(), l = {
                    ...
                    update: function(a, b) {
                        b || a.getUTCFullYear() !== l.year || a.getUTCMonth() !== l.month ? (angular.extend(l, {
                            year: e.$date.getUTCFullYear(),
                            month: e.$date.getUTCMonth(),
                            date: e.$date.getUTCDate()
                        }), e.$build()) : a.getUTCDate() !== l.date && (l.date = e.$date.getUTCDate(), e.$updateSelected());
                    },
                    build: function() {
                        for (var b, c = [], e = new Date(Date.UTC(l.year, l.month, 1)), h = new Date(+e - 864e5 * (e.getUTCDay() + 1 - g.weekStart)), i = 0; 35 > i; i++) b = new Date(+h + 864e5 * i), 
                        c.push({
                            date: b,
                            label: d(b, this.format),
                            selected: this.isSelected(b),
                            muted: b.getUTCMonth() !== l.month,
                            disabled: this.isDisabled(b)
                        });
                        f.title = d(e, "MMMM yyyy"), f.labels = j, f.rows = a(c, this.split), f.width = 100 / this.split, 
                        f.height = (this.height - 75) / f.rows.length;
                    },
                    ...
                    update: function(a) {
                        a.getUTCFullYear() !== l.year ? (angular.extend(l, {
                            year: e.$date.getUTCFullYear(),
                            month: e.$date.getUTCMonth(),
                            date: e.$date.getUTCDate()
                        }), e.$build()) : a.getUTCMonth() !== l.month && (angular.extend(l, {
                            month: e.$date.getUTCMonth(),
                            date: e.$date.getUTCDate()
                        }), e.$updateSelected());
                    },
                    build: function() {
                        for (var b, c = [], g = 0; 12 > g; g++) b = new Date(Date.UTC(l.year, g, 1)), c.push({
                            date: b,
                            label: d(b, this.format),
                            selected: e.$isSelected(b),
                            disabled: this.isDisabled(b)
                        });
                        f.title = d(b, "yyyy"), f.labels = !1, f.rows = a(c, this.split), f.width = 100 / this.split, 
                        f.height = (this.height - 50) / f.rows.length;
                    },
                    isSelected: function(a) {
                    ...
                    update: function(a) {
                        parseInt(a.getUTCFullYear() / 20, 10) !== parseInt(l.year / 20, 10) ? (angular.extend(l, {
                            year: e.$date.getUTCFullYear(),
                            month: e.$date.getUTCMonth(),
                            date: e.$date.getUTCDate()
                        }), e.$build()) : a.getUTCFullYear() !== l.year && (angular.extend(l, {
                            year: e.$date.getUTCFullYear(),
                            month: e.$date.getUTCMonth(),
                            date: e.$date.getUTCDate()
                        }), e.$updateSelected());
                    ...
                    build: function() {
                        for (var b, c = l.year - l.year % (3 * this.split), g = [], h = 0; 12 > h; h++) b = new Date(Date.UTC(c + h, 0, 1)), 
                        g.push({
                            date: b,
                            label: d(b, this.format),
                            selected: e.$isSelected(b),
                        ...
                        f.width = 100 / this.split, f.height = (this.height - 50) / f.rows.length;
                    },
                    isSelected: function(a) {
            ...
            function d(d, e) {
                function f(a) {
                    return a.map(function(a) {
                        var b, c, d = {};
                        return d[k] = a, b = j(d), c = n(d), angular.isObject(c) && (c = b), {
                            label: b,
                            value: c
                        };
                    });
        ...
        this.$get = [ "$window", "$rootScope", "$compile", "$q", "$templateCache", "$http", "$animate", "$timeout", "dimensions", function(c, d, e, f, g, h, i, j, k) {
            function l(b, c) {
                ...
                return q.$promise.then(function(a) {
                    ...
                    i.leave(w, function() {}), s.$$phase || s.$digest(), q.$isShown = !1, r.keyboard && w.off("keyup", q.$onKeyUp);
                }, q.toggle = function() {
